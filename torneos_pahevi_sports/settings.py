"""
Django settings for torneos_pahevi_sports project.
...
MIDDLEWARE = [
    ...
    'torneos.middleware.AuditoriaModificacionesMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'torneos.context_processors.validaciones_pendientes',
            ],
        },
    },
]
