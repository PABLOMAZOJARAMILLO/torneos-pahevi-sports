...
urlpatterns = [
    ...
    path('manifest.webmanifest', views.manifest_webapp, name='manifest_webapp'),
    ...
    path('gestion/jugadores/descargar-inscritos/', views.descargar_jugadores_inscritos, name='descargar_jugadores_inscritos'),
    path('gestion/jugadores/pisaron-cancha/', views.gestion_jugadores_cancha, name='gestion_jugadores_cancha'),
    path('gestion/jugadores/pisaron-cancha/descargar/', views.descargar_jugadores_cancha, name='descargar_jugadores_cancha'),
    ...
    path('gestion/jugadores/<int:jugador_id>/reemplazar/', views.gestion_jugador_reemplazar, name='gestion_jugador_reemplazar'),
    ...
    path('gestion/partidos/franjas/', views.gestion_franjas_partidos, name='gestion_franjas_partidos'),
