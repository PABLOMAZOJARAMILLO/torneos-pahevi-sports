...
class Equipo(models.Model):
    ...
    cedula_dt = models.CharField(max_length=30, blank=True, null=True, verbose_name='Cédula DT')
    ...
    cedula_at = models.CharField(max_length=30, blank=True, null=True, verbose_name='Cédula AT')
    ...
    auxiliar_campo = models.CharField(max_length=150, blank=True, null=True, verbose_name='Auxiliar de campo (AC)')
    cedula_ac = models.CharField(max_length=30, blank=True, null=True, verbose_name='Cédula AC')
    telefono_ac = models.CharField(max_length=30, blank=True, null=True, verbose_name='Celular AC')
